/**
    ...
    `CFFGLPluginInfo` that Plugin.cpp registers at static-initialisation time.
    ...
    which build it is.
        ...
        strings Compander.bundle/Contents/MacOS/Compander | grep compander
*/

extern "C" const char* CompanderBuildStamp()
{
	return "compander " COMPANDER_VERSION " built " __DATE__ " " __TIME__;
}
