...
**[v0.1.3](https://github.com/stoatworks-labs/compander/releases/tag/v0.1.3)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`compander-0.1.3-macos-universal.dmg`](https://github.com/stoatworks-labs/compander/releases/download/v0.1.3/compander-0.1.3-macos-universal.dmg) | 223 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`compander-0.1.3-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/compander/releases/download/v0.1.3/compander-0.1.3-windows-x86_64-setup.exe) | 224 KB |
