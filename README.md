...
**[v0.1.2](https://github.com/stoatworks-labs/compander/releases/tag/v0.1.2)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`compander-0.1.2-macos-universal.dmg`](https://github.com/stoatworks-labs/compander/releases/download/v0.1.2/compander-0.1.2-macos-universal.dmg) | 223 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`compander-macos-universal.zip`](https://github.com/stoatworks-labs/compander/releases/latest/download/compander-macos-universal.zip) | 186 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`compander-0.1.2-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/compander/releases/download/v0.1.2/compander-0.1.2-windows-x86_64-setup.exe) | 223 KB |
